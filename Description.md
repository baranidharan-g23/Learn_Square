...
TECHNOLOGIES USED
The main purpose of this app is to help the disabled the disabled child in education aspects.This app was made with many technical aspects.										Flutter was used to build our application as our main focus was to  help users to access our app in both android and ios. Since this app was designed to help the physically challenged children the app has many accesses with the physical mode settings i.e like access to vibration ,access to camera settings ,audio ,microphone and internet connectivity.
